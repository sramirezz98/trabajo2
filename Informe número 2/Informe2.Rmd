...
```{r}
library(DT)
descripcion <- summary(datos_cluster[etiqueta_grupo==1,])
...
```{r}
descripcion <- summary(datos_cluster[etiqueta_grupo==2,])
descripcion <- as.data.frame(descripcion)
descripcion$Var1 <- rep.int(1:6,nrow(descripcion)/6)
...
```{r}
descripcion <- summary(datos_cluster[etiqueta_grupo==3,])
descripcion <- as.data.frame(descripcion)
descripcion$Var1 <- rep.int(1:6,nrow(descripcion)/6)
...
```{r}
descripcion <- summary(datos_cluster[etiqueta_grupo==4,])
descripcion <- as.data.frame(descripcion)
descripcion$Var1 <- rep.int(1:6,nrow(descripcion)/6)
