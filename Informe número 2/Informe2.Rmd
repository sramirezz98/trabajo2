...
Teniendo en cuenta el diagrama de codos, a pesar de que se sugiere trabajar con k=2 se puede analizar que la segmentación queda con unos grupos totalmente desproporcionados puesto que queda uno muy grande y otro muy pequeño. Además, se evidencia que a partir de 4 grupos deja de ser significativo el cambio. Por dicha razón, se evidencian cuatro grupos interesantes para estudiar. 
...
-   *Variables de comportamiento de los clientes en canales y productos*
    -   En las entradas, el valor del ticket promedio se encuentra en el cuartil 1. De la misma manera, la cantidad de transacciones mensuales promedio se encuentran en el cuartil 1. De esto se puede concluir que a este grupo pertenecen aquellas empresas con valores más bajos de entrada y con número de transacciones más bajas.
    -   En las salidas, el valor del ticket promedio se encuentra en el cuartil 1. De la misma manera, la cantidad de transacciones mensuales promedio se encuentran en el cuartil 1. De lo anterior, se concluye que este grupo de empresas tienen los valores más bajos de salida tanto para los tickets como para el número de transacciones.
    
Podría pensarse entonces que las empresas pertenecientes a este grupo son pequeñas, dado que sus movimientos o cantidad de transacciones por medio de entornos físicos y/o virtuales son bajos, ya sean de entrada o de salida. Podría intuirse que dado a su clasificación de tamaño, que los ingresos y egresos son acordes, pues el valor de sus transacciones tanto de entrada como de salida son muy bajos dentro del total de clientes. 
...
-   *Variables de comportamiento de los clientes en canales y productos*
    -   En las entradas, el valor del ticket promedio en cuartil 2-3-4 para todos los canales a excepción del 7,10 y otros, que se encuentra en el cuartil 1. Cantidad de transacciones mensuales promedio en cuartil 2-3-4 para todos los canales, a excepción del 7,10 y otros que se encuentra en el cuartil 1.
    -   En las salidas, Valor del ticket promedio en cuartil 1 y 2, la cantidad de transacciones mensuales promedio se encuentran en el cuartil 1 y 3. 
    
Este grupo está conformado por empresas medianas, pues posee una cantidad considerable de transacciones de entrada, con valores de transacciones medios/elevados, por lo que ofrecen productos y/o servicios de más calidad. Además, no suelen utilizar canales como el 7,10 y otros; y cuando lo hacen, el valor medio de sus transacciones se encuentra en el menor rango. Podría existir desconfianza para dichos canales (¿?).
...
-   *Variables de comportamiento de los clientes en canales y productos*
    -   En las entradas, el Valor del ticket promedio en cuartil 4 para todos los canales a excepción del 7,10 y otros, que se encuentra en el cuartil 1 y 2. Cantidad de transacciones mensuales promedio en cuartil 4 para todos los canales, a excepción del 7,10 y otros que se encuentra en el cuartil 1 y 2.
    -   En las salidas, Valor del ticket promedio en cuartil 4, 1 y 2, la Cantidad de transacciones mensuales promedio en el cuartil 4, 1 y 2. 
    
Este grupo cuenta con empresas grandes, pues posee gran cantidad de transacciones promedio de entrada que ofrecen productos y/o servicios de alta calidad, pues poseen un valor de transacciones alto. Al igual que el grupo 2, estas empresas usan poco los canales 7,10 y otros para todo lo relacionado con las entradas, como por ejemplo recaudos y consignaciones. Podría decirse que existe desconfianza en el uso de dichos canales.
...
-   *Variables de comportamiento de los clientes en canales y productos*
    -   En las entradas, Valor del ticket promedio en cuartil 4 para todos los canales a excepción del 7,10 y otros, que se encuentra en el cuartil 1 y 2. Cantidad de transacciones mensuales promedio en cuartil 4 para todos los canales, a excepción del 7,10 y otros que se encuentra en el cuartil 1 y 2
    -   En las salidas, Valor del ticket promedio en cuartil 4, 1 y 2, Cantidad de transacciones mensuales promedio en el cuartil 4, 1 y 2
    
Este grupo cuenta con empresas grandes que ofrecen productos y/o servicios de alta calidad, pues cuentan con gran cantidad de entradas para la mayoría de sus canales con valores de transacción promedio elevados. Las empresas de este grupo también poseen desconfianza en los canales 7,10 y otros para todo lo relacionado con devoluciones, recaudos, consignaciones, entre otros; dado que la cantidad de transacciones y el valor de estas es bajo. Existe desconfianza en el uso de dichos canales para transacciones de entrada importantes.
Cantidad de transacciones y valor promedio de transacción para las salidas está entre bajo (1-2) y alto (4). Se puede explicar por la gran cantidad de movimientos dado que son empresas grandes (¿¡)
