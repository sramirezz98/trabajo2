...
```{r}
hist(datos_completos$en_vm_canal1)
hist(datos_completos$en_vm_canal2)
hist(datos_completos$en_vm_canal3)
hist(datos_completos$en_vm_canal4)
hist(datos_completos$en_vm_canal5)
hist(datos_completos$en_vm_canal6)
hist(datos_completos$en_vm_canal7)
hist(datos_completos$en_vm_canal8)
hist(datos_completos$en_vm_canal9)
hist(datos_completos$en_vm_canal10)
hist(datos_completos$en_vm_otros)
hist(datos_completos$en_tx_canal1)
hist(datos_completos$en_tx_canal2)
hist(datos_completos$en_tx_canal3)
hist(datos_completos$en_tx_canal4)
hist(datos_completos$en_tx_canal5)
hist(datos_completos$en_tx_canal6)
hist(datos_completos$en_tx_canal7)
hist(datos_completos$en_tx_canal8)
hist(datos_completos$en_tx_canal9)
hist(datos_completos$en_tx_canal10)
hist(datos_completos$en_tx_otros)
hist(datos_completos$impo_cv)
hist(datos_completos$expo_vt)
hist(datos_completos$cxp)
hist(datos_completos$cxc)
hist(datos_completos$totalinventory)
hist(datos_completos$pagos_pj)
hist(datos_completos$pagos_pn)
hist(datos_completos$tiene_ventas_fisicas)
hist(datos_completos$tiene_ventas_electronicas)
hist(datos_completos$rotacion_inventarios)
hist(datos_completos$rotacion_cxc)
hist(datos_completos$rotacion_cxp)
hist(datos_completos$ciclo_negocio)
hist(datos_completos$ciclo_financiero)
```
...
percentil<-quantcut(datos_cluster$en_vm_canal1, q = 10)
datos_cluster$percentil <- percentil
datos_cluster$percentil <- as.character(datos_cluster$percentil)
datos_cluster <- datos_cluster %>% mutate(percentil = ifelse(percentil == "[0,7.93e+05]", 1, percentil), 
                          percentil = ifelse(percentil == "(7.93e+05,2.5e+07]", 2, percentil),
                           percentil = ifelse(percentil == "(2.5e+07,8.3e+07]", 3, percentil),
                            percentil = ifelse(percentil == "(8.3e+07,1.78e+08]", 4, percentil),
                             percentil = ifelse(percentil == "(1.78e+08,3.49e+08]", 5, percentil),
                              percentil = ifelse(percentil == "(3.49e+08,6.01e+08]", 6, percentil),
                               percentil = ifelse(percentil == "(6.01e+08,9.63e+08]", 7, percentil),
                                percentil = ifelse(percentil == "(9.63e+08,1.72e+09]", 8, percentil),
                                 percentil = ifelse(percentil == "(1.72e+09,3.69e+09]", 9, percentil),
                                  percentil = ifelse(percentil == "(3.69e+09,2.51e+11]", 10, percentil))



datos_cluster$en_vm_canal2 <- quantcut(datos_cluster$en_vm_canal2,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_vm_canal3 <- quantcut(datos_cluster$en_vm_canal3,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_vm_canal4 <- quantcut(datos_cluster$en_vm_canal4,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_vm_canal5 <- quantcut(datos_cluster$en_vm_canal5,q = 4,labels = c("1","2","3","4"))
datos_cluster$en_vm_canal6 <- quantcut(datos_cluster$en_vm_canal6,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_vm_canal7 <- quantcut(datos_cluster$en_vm_canal7,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_vm_canal8 <- quantcut(datos_cluster$en_vm_canal8,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_vm_canal9 <- quantcut(datos_cluster$en_vm_canal9,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_vm_canal10 <- quantcut(datos_cluster$en_vm_canal10,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_vm_otros <- quantcut(datos_cluster$en_vm_otros,q = 4,labels = c("1","2","3","4"))
...
#datos_cluster$en_tx_canal3 <- quantcut(datos_cluster$en_tx_canal3,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_tx_canal4 <- quantcut(datos_cluster$en_tx_canal4,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_tx_canal5 <- quantcut(datos_cluster$en_tx_canal5,q = 4,labels = c("1","2","3","4"))
datos_cluster$en_tx_canal6 <- quantcut(datos_cluster$en_tx_canal6,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_tx_canal7 <- quantcut(datos_cluster$en_tx_canal7,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_tx_canal8 <- quantcut(datos_cluster$en_tx_canal8,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_tx_canal9 <- quantcut(datos_cluster$en_tx_canal9,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_tx_canal10 <- quantcut(datos_cluster$en_tx_canal4,q = 4,labels = c("1","2","3","4"))
#datos_cluster$en_tx_otros <- quantcut(datos_cluster$en_tx_otros,q = 4,labels = c("1","2","3","4"))

                                                                                          
datos_cluster$sal_vm_canal2 <- quantcut(datos_cluster$sal_vm_canal2,q = 4,labels = c("1","2","3","4"))
#datos_cluster$sal_vm_canal5 <- quantcut(datos_cluster$sal_vm_canal5,q = 4,labels = c("1","2","3","4"))
#datos_cluster$sal_vm_canal8 <- quantcut(datos_cluster$sal_vm_canal8,q = 4,labels = c("1","2","3","4"))
#datos_cluster$sal_vm_otros <- quantcut(datos_cluster$sal_vm_otros,q = 4,labels = c("1","2","3","4"))

datos_cluster$sal_tx_canal2 <- quantcut(datos_cluster$sal_tx_canal2,q = 4,labels = c("1","2","3","4"))
#datos_cluster$sal_tx_canal5 <- quantcut(datos_cluster$sal_tx_canal5,q = 4,labels = c("1","2","3","4"))
#datos_cluster$sal_tx_canal8 <- quantcut(datos_cluster$sal_tx_canal8,q = 4,labels = c("1","2","3","4"))
#datos_cluster$sal_tx_otros <- quantcut(datos_cluster$sal_tx_canal_otros,q = 4,labels = c("1","2","3","4"))
...
Explicación función gower distance:
https://www.rdocumentation.org/packages/cluster/versions/2.1.2/topics/daisy

```{r}
dist_gower <- daisy(datos_cluster,metric = "gower",type = list(asymm=C(38,39)))
summary(dist_gower)
```
Haciendo agrupamiento jerarquico/aglomerativo, utilizando ward.D como método para medir distancias entre grupos.


```{r}
cluster_jerar <- hclust(dist_gower,method = "ward.D")
plot(cluster_jerar)
```

Si seleccionamos 4 grupos
```{r}
etiqueta_grupo <- cutree(cluster_jerar,k=4)
table(etiqueta_grupo)
```
Mejorando el dendograma
```{r}
library("dendextend")
...
```
Ver las características de cada grupo...
```{r}
summary(datos_cluster[etiqueta_grupo==1,])
```


Agrupamiento jerarquico divisivo

```{r}
divisive.clust <- diana(as.matrix(dist_gower), 
